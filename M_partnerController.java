 ...
 * @author DELL
 */
public class M_partnerController implements Initializable {
    ...
    public void toapply (ActionEvent event) throws IOException {

        Parent root = FXMLLoader.load(getClass().getResource("M_Apply.fxml"));
